    ...
    return (
        <>
            ...
            <div className='privacy-policy'>
                <h1 className='text-center privacy-policy-heading'>
                    Privacy Policy for PawWorld
                </h1>

                <p>
                    At PawWorld, one of our main priorities is the privacy of
                    our visitors. This Privacy Policy document contains types of
                    information that is collected and recorded by PawWorld and
                    how we use it.
                </p>
                ...
                <p>
                    ...
                    information that they shared and/or collect in PawWorld.
                ...
                <p>
                    PawWorld follows a standard procedure of using log files.
                ...
                <p>
                    ...
                    each of the advertising partners of PawWorld.
                </p>

                <p>
                    Third-party ad servers or ad networks uses technologies like
                    cookies, JavaScript, or Web Beacons that are used in their
                    respective advertisements and links that appear on PawWorld,
                ...
                <p>
                    Note that PawWorld has no access to or control over these
                ...
                <p>
                    PawWorld's Privacy Policy does not apply to other
                ...
                <p>
                    PawWorld does not knowingly collect any Personal
